...
public class stats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int getBloodSugar = getIntent().getIntExtra("BloodSugar",0);

        //Convert to int to use in function
        int intTime = Integer.parseInt(getTime);
        int intBloodSugar = getBloodSugar;
        ...
        int mX = intTime;
        int mY = intBloodSugar;
        mScatterPlot = (GraphView) findViewById(R.id.bloodSugarGV);
